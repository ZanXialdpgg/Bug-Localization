...
This is my implementation for this paper https://ieeexplore.ieee.org/document/9719906 "An Imbalanced Deep Learning Model for Bug Localization"
...
I've working on AspectJ, SWT and Tomcat dataset only due to limited computing resource. But the training pipeline, evaluate metric is complete for anyone to replicating the rest of the dataset.
